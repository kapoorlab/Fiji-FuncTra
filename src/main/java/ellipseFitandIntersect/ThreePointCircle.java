...
public class ThreePointCircle {
	...
	public ThreePointCircle(final double[] center, final double[] start, final double[] mid, final double[] end, final double radii, double sign) {
	...
	public static ThreePointCircle FitCircleMA(final double[] pa, final double[] pb, final double[] pc) {
		...
		// Points can not be collinear
				if ((pa[0] == pb[0] && pb[0] == pc[0]) || (pa[1] == pb[1] && pb[1] == pc[1])) {
					...
					centrad[1] = 0; // y
					centrad[2] = -1; // radius
					ThreePointCircle threepoint = new ThreePointCircle(new double[] { centrad[0], centrad[1] },pa, pb, pc, centrad[2], 0);
					return threepoint;
				}
				...
				ThreePointCircle threepoint = new ThreePointCircle(new double[] { centrad[0], centrad[1] },pa, pb,pc, centrad[2], sign);
				return threepoint;
				
	}
	
	public static ThreePointCircle FitCircleMb(final double[] pa, final double[] pb, final double[] pc) {
		double[] centrad = new double[3];
		// Points can not be collinear
		if ((pa[0] == pb[0] && pb[0] == pc[0]) || (pa[1] == pb[1] && pb[1] == pc[1])) {
			centrad[0] = 0; // x

...
public class GaussianMaskFitMSER {
	...
	public static double[] sumofgaussianMaskFit(final RandomAccessibleInterval<FloatType> signalInterval,
			...
			final boolean halfgaussian, int label, double noiselevel, double R) throws Exception {
		...
		// System.out.println("Number of photons on this pixel (Relative): " +
		// Numphotons);
